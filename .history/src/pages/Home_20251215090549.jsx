...
const Home = () => {
 ...
 <h1 style={{justifyContent:"center", textAlign:"center" ,marginTop:"15%"}}>টেন মিনিট স্কুল কোর্স</h1>

 <h6 style={{justifyContent:"center", textAlign:"center" ,marginTop:"5%"}}>টেন মিনিট স্কুল কোর্স</h6>
