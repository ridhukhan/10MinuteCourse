...
const Home = () => {
 ...
 <h6 style={{justifyContent:"center", textAlign:"center" ,marginTop:"5%",color:"darkgrey"}}>টেন মিনিট স্কুলের সব কোর্সে সর্বোচ্চ ডিসকাউন্ট পেতে<br /> নিচের ক্যাটাগরিগুলো থেকে আপনার পছন্দের কোর্সটি বেছে নিন। চাইলে মেনু<br /> থেকেও সহজেই কোর্স খুঁজে নিতে পারেন। ধন্যবাদ!</h6>
